...
public class Edit extends javax.swing.JFrame {
     ...
     */
    public Edit() {
//    	getContentPane().setFont(new Font("Tahoma", Font.BOLD, 23));
        initComponents();
    }
    ...
    private void btnAddAction() {
        ...
        // Kiểm tra trường số điện thoại chỉ chứa số
        if (!phoneText.matches("\\d+")) {
            lbThongBao.setText("Thêm thất bại!");
            return;
        }

        // Chuyển đổi số điện thoại sang kiểu số
    ...
    private void btnEditAction(int id) {
        ...
        boolean insertCustomer = CustomerDao.editCustomer(customer);
        if (insertCustomer) {
    ...
    private void btnSaveAction() {
    	// Điều kiện hiển thị nút dựa vào `type`
        switch (_type) {
            case "INSERT":
            	btnAddAction();
                break;
